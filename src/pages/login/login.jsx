...
export default function LoginPage() {
 ...
 /*    //button භාවිතයෙන්  
  ...
  return (
    <div className="bg-picture w-full h-screen  flex justify-center items-center">
      <div className="w-[400px] h-[400px] backdrop-blur-2xl rounded-2xl flex justify-center items-center flex-col relative">
        ...
        <button className="my-8 w-[300px] h-[50px] bg-[#38daef] text-2xl text-white rounded-lg" onClick={login}>Login</button>
